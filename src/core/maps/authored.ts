...
function islandSpecs(mapId: string, groups: IslandGroup[] | undefined): { id: string; nameKey: string; locationIds: string[] }[] {
  return (groups ?? []).map((g) => ({
    id: g.id,
...
function authorMap(input: AuthoredMapInput): MapDefinition {
  const spec: MapSpec = {
    ...
    playerCountRules: { excludedBands: STD_RULES.excludedBands, emptyMerchants: input.emptyMerchants },
    deck: { industrySpread: input.spread, ...(input.locationCardsPerTown ? { locationCardsPerTown: input.locationCardsPerTown } : {}) },
  };
...
const IRON: IndustryType[][] = [['iron', 'coal'], ['iron', 'manufacturer']];
...
const SEVERN_VALE = authorMap({
  ...
  towns: [
    ...
    { id: 'farmA', band: 'farm', slots: [['juice']], x: 180, y: 400, display: 'Vale Juice Works', farm: true },
    { id: 'farmB', band: 'farm', slots: [['juice']], x: 620, y: 660, display: 'River Juice Works', farm: true },
  ],
  merchants: [
  ...
  canalLinks: [
    ['ashford', 'brookhaven'], ['ashford', 'clayton'], ['ashford', 'northgate'],
    ['brookhaven', 'dunmere'], ['brookhaven', 'elmsworth'], ['clayton', 'fenwick'],
    ['clayton', 'elmsworth'], ['dunmere', 'glenby'], ['dunmere', 'westhaven'],
    ['elmsworth', 'glenby'], ['elmsworth', 'harlow'], ['fenwick', 'harlow'],
    ['fenwick', 'eastport'], ['glenby', 'ironmoor'], ['glenby', 'kelby'],
    ['harlow', 'lowford'], ['kelby', 'marsden'], ['kelby', 'lowford'],
    ['marsden', 'southmoor'], ['lowford', 'rivermouth'], ['ironmoor', 'westhaven'],
    ['farmA', 'glenby'], ['farmB', 'lowford'],
  ],
  railLinks: [
    ['ashford', 'brookhaven'], ['ashford', 'clayton'], ['ashford', 'northgate'],
    ['ashford', 'elmsworth'], ['brookhaven', 'dunmere'], ['brookhaven', 'elmsworth'],
    ['clayton', 'fenwick'], ['clayton', 'elmsworth'], ['dunmere', 'glenby'],
    ['dunmere', 'westhaven'], ['elmsworth', 'glenby'], ['elmsworth', 'harlow'],
    ['fenwick', 'harlow'], ['fenwick', 'eastport'], ['glenby', 'ironmoor'],
    ['glenby', 'kelby'], ['harlow', 'lowford'], ['kelby', 'marsden'],
    ['kelby', 'lowford'], ['marsden', 'southmoor'], ['lowford', 'rivermouth'],
    ['ironmoor', 'westhaven'], ['harlow', 'kelby'], ['farmA', 'glenby'], ['farmB', 'lowford'],
  ],
  islands: {
    canal: [
    ...
    rail: [
      { id: 'uplands', display: 'Northern Reach', locationIds: ['ashford', 'brookhaven', 'clayton'] },
...
const HIGHLAND_REACH = authorMap({
  ...
  towns: [
    ...
    { id: 'farmA', band: 'farm', slots: [['juice']], x: 180, y: 410, display: 'Glen Juice Works', farm: true },
    { id: 'farmB', band: 'farm', slots: [['juice']], x: 600, y: 660, display: 'Loch Juice Works', farm: true },
  ],
  merchants: [
  ...
  canalLinks: [
    ['aberloch', 'braemore'], ['aberloch', 'craigholm'], ['aberloch', 'kirkwall'],
    ['braemore', 'dornie'], ['braemore', 'einich'], ['craigholm', 'fettar'],
    ['craigholm', 'einich'], ['craigholm', 'stromha'], ['dornie', 'glencairn'],
    ['einich', 'glencairn'], ['einich', 'haldane'], ['fettar', 'haldane'],
    ['glencairn', 'invermay'], ['glencairn', 'kintail'], ['haldane', 'lorne'],
    ['kintail', 'morven'], ['kintail', 'lorne'], ['morven', 'tarbert'],
    ['lorne', 'wickaby'], ['invermay', 'ullan'], ['dornie', 'ullan'],
    ['farmA', 'glencairn'], ['farmB', 'lorne'],
  ],
  islands: {
    canal: [
...
const IRON_COAST = authorMap({
  ...
  towns: [
    ...
    { id: 'farmA', band: 'farm', slots: [['juice']], x: 180, y: 430, display: 'Coast Juice Works', farm: true },
    { id: 'farmB', band: 'farm', slots: [['juice']], x: 620, y: 670, display: 'Bay Juice Works', farm: true },
  ],
  merchants: [
  ...
  canalLinks: [
    ['portwick', 'quarrend'], ['portwick', 'redhythe'], ['portwick', 'harbour'],
    ['quarrend', 'saltmere'], ['quarrend', 'thornbay'], ['redhythe', 'ulverston'],
    ['redhythe', 'thornbay'], ['redhythe', 'tradeport'], ['saltmere', 'vellmar'],
    ['thornbay', 'vellmar'], ['thornbay', 'wyreham'], ['ulverston', 'wyreham'],
    ['vellmar', 'yarcliff'], ['vellmar', 'zelby'], ['wyreham', 'amberton'],
    ['zelby', 'brindle'], ['zelby', 'amberton'], ['brindle', 'fishgate'],
    ['amberton', 'capemark'], ['yarcliff', 'oldquay'], ['saltmere', 'oldquay'],
    ['farmA', 'vellmar'], ['farmB', 'amberton'],
  ],
  merchantTiles: STANDARD_MERCHANT_TILES,
...
const SKYWARD = authorMap({
  ...
  towns: [
    ...
    { id: 'farmA', band: 'farm', slots: [['juice']], x: 180, y: 410, display: 'Sky Juice Works', farm: true },
    { id: 'farmB', band: 'farm', slots: [['juice']], x: 600, y: 660, display: 'Cloud Juice Works', farm: true },
  ],
  merchants: [
  ...
  canalLinks: [
    ['aurelia', 'borealis'], ['aurelia', 'cirrus'], ['aurelia', 'zenith'],
    ['borealis', 'delphi'], ['borealis', 'evermist'], ['cirrus', 'fjordane'],
    ['cirrus', 'evermist'], ['cirrus', 'meridian'], ['delphi', 'gallowin'],
    ['evermist', 'gallowin'], ['evermist', 'highspire'], ['fjordane', 'highspire'],
    ['gallowin', 'icarion'], ['gallowin', 'jovica'], ['highspire', 'kestrel'],
    ['jovica', 'lumeria'], ['jovica', 'kestrel'], ['lumeria', 'nadir'],
    ['kestrel', 'solstice'], ['icarion', 'aether'], ['delphi', 'aether'],
    ['farmA', 'gallowin'], ['farmB', 'kestrel'],
  ],
  // Air era: long flight arcs between hub cities (sparser, ignores terrain).
  airLinks: [
    ['aurelia', 'evermist'], ['aurelia', 'highspire'], ['aurelia', 'zenith'],
    ['evermist', 'lumeria'], ['evermist', 'kestrel'], ['highspire', 'cirrus'],
    ['highspire', 'meridian'], ['cirrus', 'fjordane'], ['lumeria', 'nadir'],
    ['lumeria', 'icarion'], ['kestrel', 'solstice'], ['jovica', 'evermist'],
    ['borealis', 'aurelia'], ['delphi', 'aether'], ['gallowin', 'evermist'],
    ['farmA', 'gallowin'], ['farmB', 'kestrel'],
  ],
  islands: {
    canal: [
    ...
    air: [
      { id: 'heights', display: 'Sky Sovereignty', locationIds: ['aurelia', 'highspire', 'cirrus'] },
...
const QUILL = fastMap(
  ...
  'hollow',
  [
    { id: 'q1', band: 'green', slots: [['cotton', 'manufacturer'], ['coal']], x: 360, y: 160, display: 'Quillford' },
    { id: 'q2', band: 'green', slots: [['iron', 'coal'], ['manufacturer']], x: 620, y: 160, display: 'Hollowby' },
    { id: 'q3', band: 'red', slots: [['pottery'], ['cotton', 'juice']], x: 240, y: 340, display: 'Mossvale' },
    { id: 'q4', band: 'red', slots: [['manufacturer', 'coal'], ['juice']], x: 500, y: 340, display: 'Penn' },
    { id: 'q5', band: 'yellow', slots: [['cotton'], ['iron']], x: 740, y: 340, display: 'Rookley' },
    { id: 'q6', band: 'green', slots: [['pottery'], ['manufacturer']], x: 500, y: 520, display: 'Sedgely' },
    { id: 'qf', band: 'farm', slots: [['juice']], x: 240, y: 520, display: 'Hollow Juice Works', farm: true },
  ],
  [
  ...
  [
    ['q1', 'q2'], ['q1', 'q3'], ['q1', 'qm1'], ['q2', 'q5'], ['q2', 'qm1'],
    ['q3', 'q4'], ['q4', 'q5'], ['q4', 'q6'], ['q3', 'qf'], ['q6', 'qm2'],
    ['q4', 'qm2'], ['q5', 'q6'],
  ],
  { 2: [], 3: [], 4: [] },
);
...
const TIN = fastMap(
  ...
  'brook',
  [
    { id: 't1', band: 'green', slots: [['cotton', 'manufacturer'], ['iron']], x: 380, y: 150, display: 'Tinbrook' },
    { id: 't2', band: 'green', slots: [['coal'], ['manufacturer']], x: 640, y: 160, display: 'Smeltby' },
    { id: 't3', band: 'red', slots: [['pottery'], ['cotton']], x: 250, y: 320, display: 'Claymoor' },
    { id: 't4', band: 'red', slots: [['iron', 'coal'], ['juice']], x: 510, y: 330, display: 'Forgeham' },
    { id: 't5', band: 'yellow', slots: [['manufacturer', 'coal'], ['pottery']], x: 760, y: 330, display: 'Kilnwick' },
    { id: 't6', band: 'green', slots: [['cotton', 'juice'], ['manufacturer']], x: 500, y: 520, display: 'Weldon' },
    { id: 'tf', band: 'farm', slots: [['juice']], x: 250, y: 500, display: 'Brook Juice Works', farm: true },
  ],
  [
  ...
  [
    ['t1', 't2'], ['t1', 't3'], ['t1', 'tm1'], ['t2', 't5'], ['t2', 'tm1'],
    ['t3', 't4'], ['t4', 't5'], ['t4', 't6'], ['t3', 'tf'], ['t6', 'tm2'],
    ['t4', 'tm2'], ['t5', 't6'],
  ],
  { 2: [], 3: [], 4: [] },
);
...
const MAPLE = fastMap(
  ...
  'maple',
  [
    { id: 'm1', band: 'green', slots: [['cotton', 'manufacturer'], ['pottery']], x: 500, y: 140, display: 'Maple Cross' },
    { id: 'm2', band: 'green', slots: [['coal'], ['iron']], x: 280, y: 250, display: 'Oakdale' },
    { id: 'm3', band: 'red', slots: [['manufacturer'], ['cotton', 'juice']], x: 720, y: 250, display: 'Birchwood' },
    { id: 'm4', band: 'red', slots: [['iron', 'coal'], ['manufacturer']], x: 360, y: 430, display: 'Elmgrove' },
    { id: 'm5', band: 'yellow', slots: [['pottery'], ['cotton']], x: 640, y: 430, display: 'Aspenford' },
    { id: 'm6', band: 'green', slots: [['manufacturer', 'coal'], ['juice']], x: 500, y: 560, display: 'Willowby' },
    { id: 'mf', band: 'farm', slots: [['juice']], x: 280, y: 500, display: 'Maple Juice Works', farm: true },
  ],
  [
  ...
  [
    ['m1', 'm2'], ['m1', 'm3'], ['m1', 'mm1'], ['m2', 'm4'], ['m3', 'm5'],
    ['m4', 'm5'], ['m4', 'm6'], ['m5', 'm6'], ['m2', 'mf'], ['m6', 'mm2'],
    ['m4', 'mm2'], ['m3', 'mm1'],
  ],
  { 2: [], 3: [], 4: [] },
);
...
const SLATE = fastMap(
  ...
  'slate',
  [
    { id: 's1', band: 'green', slots: [['cotton', 'manufacturer'], ['coal']], x: 480, y: 150, display: 'Slatepike' },
    { id: 's2', band: 'green', slots: [['iron', 'coal'], ['pottery']], x: 250, y: 270, display: 'Greyfell' },
    { id: 's3', band: 'red', slots: [['manufacturer'], ['cotton']], x: 720, y: 270, display: 'Shalecombe' },
    { id: 's4', band: 'red', slots: [['coal'], ['iron']], x: 370, y: 440, display: 'Flintmoor' },
    { id: 's5', band: 'yellow', slots: [['cotton', 'juice'], ['manufacturer']], x: 650, y: 440, display: 'Cragend' },
    { id: 's6', band: 'green', slots: [['pottery'], ['manufacturer', 'coal']], x: 500, y: 570, display: 'Talgarth' },
    { id: 'sf', band: 'farm', slots: [['juice']], x: 250, y: 510, display: 'Pike Juice Works', farm: true },
  ],
  [
  ...
  [
    ['s1', 's2'], ['s1', 's3'], ['s1', 'sm1'], ['s2', 's4'], ['s3', 's5'],
    ['s4', 's5'], ['s4', 's6'], ['s5', 's6'], ['s2', 'sf'], ['s6', 'sm2'],
    ['s4', 'sm2'], ['s3', 'sm1'],
  ],
  { 2: [], 3: [], 4: [] },
);
...
const AMBER = fastMap(
  ...
  'fen',
  [
    { id: 'a1', band: 'green', slots: [['cotton', 'manufacturer'], ['juice']], x: 500, y: 140, display: 'Amberfen' },
    { id: 'a2', band: 'green', slots: [['coal'], ['iron']], x: 280, y: 250, display: 'Reedham' },
    { id: 'a3', band: 'red', slots: [['pottery'], ['cotton']], x: 720, y: 250, display: 'Sedgemoor' },
    { id: 'a4', band: 'red', slots: [['iron', 'coal'], ['manufacturer']], x: 360, y: 430, display: 'Mirewick' },
    { id: 'a5', band: 'yellow', slots: [['manufacturer', 'coal'], ['pottery']], x: 640, y: 430, display: 'Fenwell' },
    { id: 'a6', band: 'green', slots: [['cotton'], ['manufacturer']], x: 500, y: 560, display: 'Boglea' },
    { id: 'af', band: 'farm', slots: [['juice']], x: 280, y: 500, display: 'Fen Juice Works', farm: true },
  ],
  [
  ...
  [
    ['a1', 'a2'], ['a1', 'a3'], ['a1', 'am1'], ['a2', 'a4'], ['a3', 'a5'],
    ['a4', 'a5'], ['a4', 'a6'], ['a5', 'a6'], ['a2', 'af'], ['a6', 'am2'],
    ['a4', 'am2'], ['a3', 'am1'],
  ],
  { 2: [], 3: [], 4: [] },
);
